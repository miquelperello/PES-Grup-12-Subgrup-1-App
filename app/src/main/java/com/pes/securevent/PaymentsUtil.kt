...
import com.pes.securevent.Constants
...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(Constants.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS as Map<*, *>))
        }
    }
        ...
        return try {
            baseRequest.apply {
                ...
                val shippingAddressParameters = JSONObject().apply {
                    ...
                    put("allowedCountryCodes", JSONArray(listOf("US", "GB", "ES")))
                }
